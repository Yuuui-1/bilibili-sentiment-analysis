...
def generate_top_comments_chart(num_comments=10):
    try:
        ...
        for doc in cursor:
            ...
            appreciate_counts.append(doc['reply_count'])

        # 创建柱状图
        bar = (
            Bar(init_opts=opts.InitOpts(theme=ThemeType.LIGHT))
            .add_xaxis(comments)
            .add_yaxis("回复数", appreciate_counts, label_opts=opts.LabelOpts(is_show=False))
            .set_global_opts(
        ...
        # 生成HTML文件
        output_path = "D:/pycharm_xiangmu3/templates/top_comments_chart2.html"
